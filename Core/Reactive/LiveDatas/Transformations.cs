...
namespace Core.Reactive.LiveDatas
{
    ...
    public static class Transformations
    {
        ...
        /// <see cref="EventHandler{TEventArgs}"/>, to an <see cref="LiveData{TEventArgs}"/>. 
        ...
        /// <summary>
        /// Converts a .NET observable stream, conforming to the standard .NET observable pattern based on
        /// <see cref="IObservable{TData}"/>, to an <see cref="LiveData{TEventArgs}"/>. 
        /// 
        /// Each <see cref="IObserver{TData}.OnNext(TData)"/> invocation is surfaced through an 
        /// <see cref="LiveData{TEventArgs}.PropertyChanged"/> invocation.
        /// 
        /// </summary>
        /// <typeparam name="TData">The type of the data generated by the observable stream</typeparam>
